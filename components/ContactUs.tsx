...
import { EnvelopeIcon, PhoneArrowUpRightIcon } from "@heroicons/react/24/outline"; // valid icons
...
export default function ContactUs() {
  ...
  return (
    <section id="contact" className="min-h-screen bg-gradient-to-b from-indigo-950 via-blue-950 to-indigo-950 text-white px-6 py-24">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-bold text-cyan-300 mb-6"
        >
          Contact Us
        </motion.h1>
        <motion.p
          ...
          className="text-blue-200 text-lg md:text-xl mb-16 max-w-3xl mx-auto"
        >
          Have questions or feedback? We are here to help. Reach out to us via email, phone, or social media. You can also send your feedback directly through the form below.
        </motion.p>
        ...
        >
          <h2 className="text-3xl font-semibold text-cyan-300 mb-6">Send Us Your Feedback</h2>
