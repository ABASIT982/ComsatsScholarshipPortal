    ...
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-gradient-to-r from-blue-900/80 via-indigo-900/70 to-purple-900/70 border-b border-blue-400/20 shadow-lg">
      <div className="w-full px-6 md:px-16 py-3 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          {/* -------------------------- These are Login Buttons for studetn and admin  --------------------------------*/}
        ...
        {/* -----------------This is for Mobile Menu Button - FIXED FOR IPAD (shows on md and lg screens) ----------------- */}
        <button
      ...
      {/* ------------------This is for BACKGROUND OVERLAY when menu open ----------------------------*/}
      {isOpen && (
        <div
          className="fixed inset-0 bg-black/40 backdrop-blur-sm z-30 lg:hidden"
          onClick={() => setIsOpen(false)} // When ever Click outside closes menu
        ></div>
      )}

      {/* ---------------This is for Mobile Sidebar Menu --------------*/}
      <div
      ...
      >
        {/* -----------------This is for Sidebar Header with Logo ---------------------*/}
